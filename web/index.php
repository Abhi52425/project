...
$result = $connection->query($query);
 ...
 if (isset($_POST['todoValue'])) {
	 $todoValue = $_POST['todoValue'];
		...
		$query = "insert into tasks (task) VALUES('$todoValue')";
...
<html>
<head>
<title>Chitkara university Clubs</title>
 ...
 <body class="sticky-header left-side-collapsed"  onload="initMap()">
    ...
    <!-- left side start-->
		<div class="left-side sticky-left-side">
			...
			<div class="logo">
				<h1><a href="index.php">Club <span>Admin</span></a></h1>
			</div>
			...
			<div class="left-side-inner">
				...
				<!--sidebar nav start-->
					<ul class="nav nav-pills nav-stacked custom-nav">
						...
						<li class="menu-list"><a href="#"><i class="lnr lnr-envelope"></i> <span>Chat</span></a>
							<ul class="sub-menu-list">
								<li><a href="/user/web/groupchat/">Chatroom</a> </li>
						...
						<li class="menu-list"><a href="#"><i class="lnr lnr-book"></i>  <span>Register</span></a> 
							<ul class="sub-menu-list">
					...
					<div class="scrollbar scrollbar1" id="style-2">
						...
						<div class="activity-row">
							...
							<div class="col-xs-7 activity-desc">
								<h5><a href="#">Ms. Shefali Batra</a></h5>
								<p>Faculty Coordinator S</p>
							</div>
							<div class="col-xs-2 activity-desc1"><h6></h6></div>
							<div class="clearfix"> </div>
						</div>
							<div class="col-xs-3 activity-img"><img src='images/1.png' class="img-responsive" alt=""/></div>
							<div class="col-xs-7 activity-desc">
								<h5><a href="#">HARSHITA GUPTA</a></h5>
								<p>PRESIDENT</p>
							</div>
							<div class="col-xs-2 activity-desc1"><h6></h6></div>
							<div class="clearfix"> </div>
			...
			<div class="col-md-4 span_8">
				<div class="activity_box activity_box2">
							...
							<div class="single-bottom">
								...
								?>
									<li>
										...
										<label for="brand"><span></span><?php echo $row[1] ?></label>
									</li>
								<?php
								}
								?>
					...
					<form action="" method="post">
						<input type="text" value="Enter your text" name = "todoValue" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Enter your text';}" required="">
